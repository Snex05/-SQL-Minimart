...
select productID,ProductName,UnitPrice from Products where productID>100

-- 5. รหัสสินค้า และราคาของยางลบ
select productID,UnitPrice,ProductName from Products where ProductName='ยางลบ'
...
where ProductName in ('ของแชมพู','แป้งเด็ก','ดินสอ','ยางลบ')
